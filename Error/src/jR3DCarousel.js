		...
		(function setup(){
			...
			function _createControls(){
				...
				_previousButton.add(_nextButton)
							   .css({position: 'absolute', top:'50%', zIndex:1, transform: 'translateY(-50%)', fontSize: '4em', color: '#000000', cursor:'pointer', userSelect: 'none'})
							   .appendTo(_container)
							   .hide();
				...
				_previousButton.hover(function(){
					_previousButton.css({color: '#000000'});
				},function(){
					_previousButton.css({color: '#000000'});
				});
				_nextButton.hover(function(){
					_nextButton.css({color: '#000000'});
				},function(){
					_nextButton.css({color: '#000000'});
				});
